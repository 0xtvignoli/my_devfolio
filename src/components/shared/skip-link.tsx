...
export function SkipLink({ label }: SkipLinkProps) {
  return (
    <a
      href="#main-content"
      className="sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[9999] focus:inline-block focus:h-auto focus:w-auto focus:overflow-visible focus:rounded-[4px] focus:border focus:border-foreground focus:bg-background focus:px-4 focus:py-2 focus:font-medium focus:text-foreground focus:outline-none focus:ring-1 focus:ring-ring focus:ring-offset-2 focus:[clip:auto] focus:[margin:0]"
    >
      {label}
    </a>
  );
