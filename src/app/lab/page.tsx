...
function LabPageContent() {
  ...
  return (
    <div ref={containerRef} className="space-y-6 h-full flex flex-col touch-pan-y select-none">
      ...
      <Tabs defaultValue="prod-workload" className="w-full flex-1 flex flex-col" onValueChange={(value) => setActiveTab(value as 'prod-workload' | 'ai-scenario')}>
        <TabsList className="grid w-full grid-cols-2 md:w-[400px]">
          <TabsTrigger value="prod-workload"><Server className="mr-2 h-4 w-4"/>Production Workload</TabsTrigger>
          <TabsTrigger value="ai-scenario"><BrainCircuit className="mr-2 h-4 w-4" />AI Case Scenario</TabsTrigger>
        </TabsList>
                ...
                <div className="xl:col-span-3 grid gap-6 content-start">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Real-time performance data from the stable production environment.</CardDescription>
                        </CardHeader>
                 ...
                 <div className="xl:col-span-2 grid gap-6 content-start">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Inject failures into the production workload to test its resilience.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <ChaosControl />
                        </CardContent>
