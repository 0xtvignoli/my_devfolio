...
const labProject = {
  ...
  summary:
    'A hands-on, simulated environment to demonstrate and explore core DevOps concepts, including CI/CD, container orchestration, and incident management.',
    ...
    <div className="space-y-20 sm:space-y-32">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
        <div className="lg:col-span-2 space-y-6">
          ...
          <p className="text-lg text-muted-foreground max-w-xl">
            Bridging the gap between development and operations. I build resilient, scalable, and
            automated systems to accelerate software delivery and enhance reliability.
          </p>
      ...
      <section className="space-y-8">
        <SectionHeader
          ...
          align="center"
          subtitle="Tools and platforms I use to build resilient systems."
        />
      ...
      <section className="space-y-8">
        <SectionHeader
          ...
          align="center"
          subtitle="A snapshot of work spanning cloud, DevOps, and platform engineering."
        />
